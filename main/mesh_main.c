...
static const char *resolution_camera[] = {

    "FRAMESIZE=96X96",    // 96x96
...
void esp_mesh_p2p_rx_main(void *arg)
{
    ...
    while (is_running) {
        ...
        if (idx == 99){
            ...
            ESP_LOGI(MESH_TAG, "Picture %d Size:%d Total:%d Seq:%d %s", rx_buf[3], size_picture, rx_buf[1], rx_buf[2], resolution_camera[rx_buf[0]]);
